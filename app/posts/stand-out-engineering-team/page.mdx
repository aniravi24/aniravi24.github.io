...
Many of the best engineers work for companies that produce open-source software or allow for major contributions to open-source projects. Many engineers feel a deep debt of gratitude to open-source work and it's a great way to attract talent.
